...
def index (request):
	"""Vista de la pagina principal de la aplicacion.
		...
		Tambien se da la opcion de registrar una nueva empresa
...
def valoraciones (request, empresa_id):
	"""Vista de las valoraciones asociadas a una empresa.
		...
		Lista todas las valoraciones que ha recibido una empresa 
...
def add_empresa(request):
	"""Vista de la funcionalidad de add_empresa.
		...
		Comprueba que dicho formulario es valido en relacion al modelo y en caso de ser valido, almacena en
